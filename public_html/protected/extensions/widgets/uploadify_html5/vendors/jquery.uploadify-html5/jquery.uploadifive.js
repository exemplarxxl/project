            ...
            return this.each(function() {
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    ...
                    if (settings.removeCompleted) {
                        setTimeout(function() { methods.cancel.call($this, file); }, settings.removeTimeout);
                    }
                    file.complete = true;
                ...
                if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                    ...
                    $data.button = $('<div id="' + settings.id + '" class="btn btn-mini btn-success">' + settings.buttonText + '</div>');
